        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-right">
                    <li>
                        <a href="#" style="color: #00cccc" data-toggle="modal" data-target="#addNindya"><span class="glyphicon glyphicon-plus" aria-hidden="true"></span> Nindya Baru</a>
                    </li>
                </ul>
            </div>
            <!-- /.navbar-collapse -->
	  ...
	  <div class="modal-dialog" role="document">
		<div class="modal-content">
		  <div class="modal-header">
			...
			<h4 class="modal-title">Tambah Nindya Baru</h4>
		  </div>
		  <div class="modal-body">
			<div class="row">
				<div class="col-md-4">
					<img src="http://via.placeholder.com/250x300?text=Nindya" class="img-responsive">
				</div>
				<div class="col-md-8">
					<form>
					  ...
					  <div class="form-group">
						...
						<input type="text" class="form-control" id="exampleInputPassword1" placeholder="Jabatan">
					  </div>
					</form>					
				</div>
			</div>
